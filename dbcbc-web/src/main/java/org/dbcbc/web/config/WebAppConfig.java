...
import org.dbcbc.common.util.SHA1Util;
...
@Configuration
@EnableWebSecurity
@ConfigurationProperties(prefix = "dbcbc.web.security")
public class WebAppConfig extends WebSecurityConfigurerAdapter implements AuthenticationProvider, HttpSessionListener {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable().authorizeRequests().antMatchers("/css/**", "/js/**", "/img/**", "/plugins/**", "/index/version.json", "/openapi/**", "/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**").permitAll().anyRequest().authenticated().and()
