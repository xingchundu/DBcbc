...
import org.dbcbc.common.config.GeneralBufferConfig;
...
import org.dbcbc.parser.model.WriterRequest;
import org.dbcbc.parser.model.WriterResponse;
import org.dbcbc.parser.strategy.FlushStrategy;
import org.dbcbc.parser.util.ConnectorInstanceUtil;
import org.dbcbc.parser.util.ConnectorServiceContextUtil;
import org.dbcbc.parser.util.ConvertUtil;
import org.dbcbc.plugin.PluginFactory;
import org.dbcbc.plugin.enums.ProcessEnum;
import org.dbcbc.plugin.impl.IncrementPluginContext;
...
public class GeneralBufferActuator extends AbstractBufferActuator<WriterRequest, WriterResponse> {
    ...
    private void parseDDl(WriterResponse response, Mapping mapping, TableGroup tableGroup) {
        try {
            ...
            DDLConfig targetDDLConfig = ddlParser.parse(tConnectorInstance, connectorService, tableGroup, response.getSql(), sConnType);
            // 1.生成目标表执行SQL
