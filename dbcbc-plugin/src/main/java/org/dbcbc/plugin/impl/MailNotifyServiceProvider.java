 ...
 */
@Component
@ConditionalOnProperty(value = "dbcbc.plugin.notify.mail.enabled", havingValue = "true")
@ConfigurationProperties(prefix = "dbcbc.plugin.notify.mail")
public final class MailNotifyServiceProvider implements NotifyService {
    ...
    private String createTemplate(String appName, String content) {
        String temp = "<!DOCTYPE html>\n" + "<html lang=\"en\">\n" + "<meta charset=\"UTF-8\">\n" + "<title>${appName}通知</title>\n" + "</head>\n" + "<body>\n" + "${content}\n"
                + "<p><a href=\"http://gitee.com/ghi/dbcbc\">访问项目</a></p>\n" + "</body>\n" + "</html>";
