...
import org.dbcbc.connector.kafka.KafkaConnectorInstance;
    ...
    public void init() {
        ...
        config.getExtInfo()
                .put(KafkaUtil.CONSUMER_PROPERTIES, "key.deserializer=org.apache.kafka.common.serialization.StringDeserializer\n"
                        + "value.deserializer=org.dbcbc.connector.kafka.serialization.JsonToMapDeserializer\n" + "auto.offset.reset=latest\n" + "enable.auto.commit=false\n"
        ...
        config.getExtInfo()
                .put(KafkaUtil.PRODUCER_PROPERTIES, "key.serializer=org.apache.kafka.common.serialization.StringSerializer\n"
                        + "value.serializer=org.dbcbc.connector.kafka.serialization.MapToJsonSerializer\n" + "acks=1\n" + "batch.size=32768\n" + "buffer.memory=33554432\n"
