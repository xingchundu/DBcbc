 ...
 */
package org.dbcbc.connector.mysql.storage;

import org.dbcbc.common.model.Paging;
import org.dbcbc.common.util.CollectionUtils;
import org.dbcbc.common.util.StringUtil;
import org.dbcbc.common.util.UnderlineToCamelUtils;
import org.dbcbc.connector.mysql.MySQLConnector;
import org.dbcbc.connector.mysql.MySQLException;
import org.dbcbc.sdk.NullExecutorException;
...
import org.dbcbc.sdk.filter.BooleanFilter;
import org.dbcbc.sdk.filter.Query;
import org.dbcbc.sdk.model.Field;
import org.dbcbc.sdk.storage.AbstractStorageService;
...
public class MySQLStorageService extends AbstractStorageService {
    ...
    private final String PREFIX_TABLE = "dbcbc_";
    ...
    public void init(Properties properties) {
        ...
        config.setConnectorType(properties.getProperty("dbcbc.storage.type"));
        String url = properties.getProperty("dbcbc.storage.mysql.url");
        String username = properties.getProperty("dbcbc.storage.mysql.username", "admin");
        String password = properties.getProperty("dbcbc.storage.mysql.password", "admin");
        ...
        config.setDriverClassName(properties.getProperty("dbcbc.storage.mysql.driver-class-name"));
        config.setUrl(url);
        logger.info("url:{}", url);
    ...
    private Executor createTableIfNotExist(String table, Executor executor) {
        ...
        // show tables where Tables_in_dbcbc = "dbcbc_config"
