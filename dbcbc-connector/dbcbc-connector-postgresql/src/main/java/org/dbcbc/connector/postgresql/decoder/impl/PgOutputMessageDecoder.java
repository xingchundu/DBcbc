 ...
 */
package org.dbcbc.connector.postgresql.decoder.impl;

import org.dbcbc.common.util.CollectionUtils;
import org.dbcbc.connector.postgresql.PostgreSQLException;
import org.dbcbc.connector.postgresql.decoder.AbstractMessageDecoder;
import org.dbcbc.connector.postgresql.enums.MessageDecoderEnum;
import org.dbcbc.connector.postgresql.enums.MessageTypeEnum;
...
public class PgOutputMessageDecoder extends AbstractMessageDecoder {
    ...
    private final Map<Integer, TableId> tables = new ConcurrentHashMap<>();
