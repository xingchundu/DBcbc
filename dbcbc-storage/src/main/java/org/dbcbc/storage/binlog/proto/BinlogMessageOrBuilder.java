...
public interface BinlogMessageOrBuilder extends
   ...
   * @return The event.
   */
  org.dbcbc.storage.binlog.proto.EventEnum getEvent();
   ...
   * @return The data.
   */
  org.dbcbc.storage.binlog.proto.BinlogMap getData();
  /**
   * <code>.BinlogMap data = 3;</code>
   */
  org.dbcbc.storage.binlog.proto.BinlogMapOrBuilder getDataOrBuilder();
}
