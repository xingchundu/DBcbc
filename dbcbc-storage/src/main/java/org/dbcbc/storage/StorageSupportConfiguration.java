...
import org.dbcbc.storage.impl.DiskStorageService;
...
public class StorageSupportConfiguration {
    ...
    private final String PREFIX_STORAGE = "dbcbc.storage";

    private final String STORAGE_TYPE = "dbcbc.storage.type";
